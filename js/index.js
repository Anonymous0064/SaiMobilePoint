...
var objPeople = [
	// {
	// 	name	: 'Ashoksinh Rajput',
	// 	username: 'Ashoksinh',
	// 	email	: 'saimobilepoint1@gmail.com',
	// 	password: 'Sai@8849336526'
	// }
];
...
if (section.id == 'signup')
{
	...
	function getInfo(){
		...
		if (usernameValue && passwordValue) {
			setTimeout(()=>{
				window.location.href = 'ourservice.html';
			}, 300);	
...
else if ( section.id =="separate-ourservice-section") {
